...
//-----------------------------------------------------------------------------------
#define WIDGET_XPOS CEGUI::UDim(0.0, 0)
#define WIDGET_YSTART CEGUI::UDim(0.1f, 0)
#define WIDGET_YOFFSET CEGUI::UDim(0.13f, 0)
...
#define ITEM_YSPACING 2
        ...
        : mItemSelectorController(0)
    {
        ...
        mScrollablePane->setWindowSize(CEGUI::UVector2(CEGUI::UDim(0.9, 0), CEGUI::UDim(0.75, 0)));
        mParentWindow->addChildWindow(mScrollablePane);
        mScrollablePane->setWindowPosition(CEGUI::UVector2(WIDGET_XPOS, WIDGET_YSTART));
...
//-----------------------------------------------------------------------------------
    void ItemSelectorViewManager::addItemSelector(const Ogre::String& displayText)
    {
        ...
        checkbox->setID(idx);
        checkbox->setWindowSize(CEGUI::UVector2(CEGUI::UDim(0, 140), CEGUI::UDim(0, ITEM_YSIZE)));
        ...
        checkbox->setWindowPosition(CEGUI::UVector2(CEGUI::UDim(0, 0), CEGUI::UDim(0, 12 + (ITEM_YSIZE + ITEM_YSPACING)* static_cast<float>(idx))));
