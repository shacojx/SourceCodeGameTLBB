...
//-----------------------------------------------------------------------------------
    void CompositorDemo::createScene(void)
    {
        ...
        mGUISystem = new CEGUI::System(mGUIRenderer,
            (CEGUI::ResourceProvider *)0,
            (CEGUI::XMLParser*)0,
            (CEGUI::ScriptModule*)0,
            (CEGUI::utf8*)"CompositorDemoCegui.config");
...
//		}
			...
			);
		{
			Ogre::CompositionTechnique *t = comp3->createTechnique();
			{
				...
				def->width.viewport = 1;
				def->height.viewport = 1;
			...
			);
		{
			...
			{
				Ogre::CompositionTechnique::TextureDefinition *def = t->createTextureDefinition("scene");
				def->width.viewport = 0.5;
				def->height.viewport = 0.5;
				def->format = Ogre::PF_R8G8B8;
			}
			{
				Ogre::CompositionTechnique::TextureDefinition *def = t->createTextureDefinition("temp");
