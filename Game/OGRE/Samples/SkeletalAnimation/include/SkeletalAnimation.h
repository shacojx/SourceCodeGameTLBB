...
protected:
    ...
    void createScene(void)
    {
        ...
        Quaternion q2(Degree(240), Vector3::UNIT_Z);
        Quaternion q3 = Quaternion::Slerp(0.3f, q1, q2, true);
        Quaternion q4 = Quaternion::Slerp(0.3f, q1, -q2, false);
        Quaternion q5(Degree(120*0.3f), Vector3::NEGATIVE_UNIT_Z);
        Quaternion q6 = Quaternion::Slerp(0.3f, q1, q2, false);
        Quaternion q7(Degree(240*0.3f), Vector3::UNIT_Z);

        mRoot->setFrameSmoothingPeriod(0);
        ...
        for (int i = 0; i < NUM_JAIQUAS; ++i)
        {
            ...
            //mat = mat->clone(mat->getName() + StringConverter::toString(i));
